        ...
        <div className="project_content">
          <div>
            ...
            <span className="project_subtitle">
              Order Nest - ERP System
            </span>
            {/* <span className="project_subtitle warning">Process....</span> */}
            <ul className="project_description">
              <li>
                Built a MERN-based web app to digitize order and delivery management for a flour mill, 
                featuring phone-based login, dynamic pricing, order tracking, and an admin dashboard for managing orders, 
                products, and staff.
              </li>
            </ul>
          </div>
          <a href="https://os-erp-system.vercel.app/" className="button" target="blank">
            {" "}
